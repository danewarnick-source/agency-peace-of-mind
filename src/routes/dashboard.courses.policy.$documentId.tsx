    ...
    return (
      <div className="space-y-3">
        ...
        <Button asChild variant="outline" size="sm">
          <Link to="/dashboard/my-obligations"><ArrowLeft className="mr-1 h-4 w-4" /> Back to personnel file</Link>
        </Button>
      </div>
    );
    ...
    <div className="-mx-4 -my-5 flex h-full min-h-[calc(100dvh-9rem)] flex-col bg-background md:min-h-[600px]">
      <header className="border-b border-border bg-card px-4 py-3">
        <Button asChild variant="ghost" size="sm" className="-ml-2 shrink-0">
          <Link to="/dashboard/my-obligations"><ArrowLeft className="mr-1 h-4 w-4" /> Personnel file</Link>
        </Button>
