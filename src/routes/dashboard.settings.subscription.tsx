...
// Interim placeholder. Self-service plan/subscription management isn't built yet;
// this is a clean holding page under Settings (where account/plan management lives).
