...
export const Route = createFileRoute("/verify/$code")({
  head: ({ params }) => ({
    meta: [
      { title: `Verify certificate ${params.code} — Provider Interface` },
      { name: "description", content: "Public certificate verification for Provider Interface issued credentials." },
    ],
  }),
