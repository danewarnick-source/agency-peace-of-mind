...
[31mNotFound: ChildProcess.spawn (docker run --rm --network host --env PG_META_DB_URL=postgresql://sandbox_exec.mmknqtdrefbzwfdtykza:97e6c7cf-89dc-4a5b-b898-2b8bb98c585f@aws-1-us-east-2.pooler.supabase.com:6543/postgres --env PG_CONN_TIMEOUT_SECS=15 --env PG_QUERY_TIMEOUT_SECS=15 --env PG_META_GENERATE_TYPES=typescript --env PG_META_GENERATE_TYPES_INCLUDED_SCHEMAS=public --env PG_META_GENERATE_TYPES_SWIFT_ACCESS_CONTROL=internal --env PG_META_GENERATE_TYPES_DETECT_ONE_TO_ONE_RELATIONSHIPS=true --env PG_META_DB_SSL_ROOT_CERT=-----BEGIN CERTIFICATE-----
