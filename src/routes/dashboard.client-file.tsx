    ...
    <div className="space-y-4">
      <div className="rounded-2xl border border-[var(--hive-gold)]/30 bg-gradient-to-br from-[#fff7ed] via-white to-white p-5 shadow-[var(--shadow-card)]">
        ...
        <p className="mt-1 max-w-2xl text-sm text-muted-foreground">
          Org-wide file status from the same artifacts as each client&apos;s Client file.
          Open a row for that person. Practice audit and evidence pull reuse Internal
          Audit — this is not a separate audit system.
        </p>
      </div>
      <OrgClientFileMatrix organizationId={org.organization_id} />
    </div>
  );
}
