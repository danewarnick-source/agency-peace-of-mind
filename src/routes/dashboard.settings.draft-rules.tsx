    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          {WORKBOOK_SOURCE_TITLE} design revision {WORKBOOK_DESIGN_REVISION}. Stage 1, Stage 2, and
          Stage 3 Core_Rule_Logic rows stay draft / not published. Simulation does not create live
