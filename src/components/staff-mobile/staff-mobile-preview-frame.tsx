 ...
 * The inner screen div is registered as the mobile shell container so every
 * overlay (bottom sheets, dialogs, paperwork pop-ups) is bounded by the
 * device frame and never escapes to full browser width.
 */
      ...
      <div className="min-h-[calc(100vh-4rem)] w-full bg-slate-200/70 px-4 py-6">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-5">
          ...
          >
            ...
            {/* Screen — positioning context for every overlay */}
            <FrameScreen
              width={device.w}
              height={device.h}
              title={title}
