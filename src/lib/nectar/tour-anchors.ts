...
export const TOUR_ANCHORS: TourAnchor[] = [
  ...
  { id: "nav.agency-documents", label: "Agency documents", route: "/dashboard/agency-documents", description: "Org-wide standing flags, encoded DSPD policies, and the company-policies binder.", surface: "admin" },
